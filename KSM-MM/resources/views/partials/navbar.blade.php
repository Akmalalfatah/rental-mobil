<nav class="bg-white border-gray-200 dark:bg-gray-900 sticky top-0 z-50">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Rent's</span>
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                @auth
                    <li>
                        <a href="/my-rentals" class="text-purple-500 hover:text-blue-700">Sewa</a>
                    </li>
                    <li>
                        <a href="/cars" class="text-purple-500 hover:text-blue-700">Mobil</a>
                    </li>
                @endauth
                @guest
                    <li>
